...
public class Edit_Exam_Form extends Activity implements OnClickListener {
	...
	// private EditText et_questionset = null ; // for absolute path of xml
	...
	private int dataId; // id received from last activity through intent for
						// edit data
		...
		public void onCheckedChanged(CompoundButton buttonView,
			...
			case R.id.radio_limit1:
				...
				if (rdb_limit.isChecked()) {
					...
					examtype = 0; // exam type 0 means time lmit
	...
	public void onClick(View v) {
		...
		case R.id.btn_create1:
			...
			if (examname.equals("")) {
				// et_examname.setTextColor(color.holo_red_dark);
			...
			// msg = "created"; // initialize msg as you done above
			break;
