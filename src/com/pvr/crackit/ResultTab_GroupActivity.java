...
public class ResultTab_GroupActivity extends ActivityGroup {

	// Keep this in a static variable to make it accessible for all the nested
	// activities, lets them manipulate the view
	public static ResultTab_GroupActivity group;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		group = this;
		ResultTab_GroupActivity.history = new ArrayList<View>();
		// Start the root activity within the group and get its view
		View view = getLocalActivityManager().startActivity("FristActivity",new Intent(this, Result_Home.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)).getDecorView();
	...
	private void back() 
	{
		...
		try {
			...
			e.printStackTrace();
			Log.d("EXCEPTION_FIRST",e.toString());
		}
	}
	public void onBackPressed() {
		...
		try {
			ResultTab_GroupActivity.group.back();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			Log.d("EXCEPTION_FIRST",e.toString());
	...
	// reset tab by clear all views
	public void resetResultTab_GroupActivity(){
		//history.clear();
		//
		//View view = getLocalActivityManager().startActivity("FristActivity",new Intent(this, Result_Home.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)).getDecorView();
		//
